...
from .resampler import ChannelResampler as Resampler
...
class detail_encoder(torch.nn.Module):
    ...
    def init_proj(self):
        resampler = Resampler(use_color_adjust=False).to(self.device, dtype=self.dtype)
        return resampler
    ...
    def generate(
        ...
        image_prompt_embeds, uncond_image_prompt_embeds = self.get_image_embeds(flaw_uv_image)
